...
### НОВОЕ: URL для Клининга (Chat2Desk) ###
...
with st.sidebar:
    ...
    ### НОВОЕ: Главный переключатель логики ###
    ...
    # ---------------------------------------------------------
    # НОВОЕ: ЛОГИКА ДЛЯ КЛИНИНГА
    # ---------------------------------------------------------
    else:
        cleaning_audience = st.radio("Аудитория:", ["Клиент", "Клинер"])
        c2d_transport = st.selectbox("Транспорт:", ["telegram"]) # Пока только телеграм, как в ТЗ
...
### НОВОЕ: Функция отправки в Chat2Desk (Клининг) ###
